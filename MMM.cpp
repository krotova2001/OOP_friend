...
int main()
{
    Matrix M; // создадим объект со случаем заполнения случайными числами
    M.Show_mass();
    Matrix N(10); // cоздаем объект с начальным значением массива - 10, без заполнения случайным числами
    N.Show_mass();
